    ...
    >
      ...
      {/* <div className="mb-6 flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
        <button
          ...
          className={`flex-1 py-2 rounded-md text-sm font-medium transition-colors ${signInMethod === 'phone'
        ...
        <button
          ...
          className={`flex-1 py-2 rounded-md text-sm font-medium transition-colors ${signInMethod === 'email'
              ? 'bg-white dark:bg-gray-700 text-primary-500 shadow-sm'
              : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
            }`}
        >
