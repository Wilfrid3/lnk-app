// This file extends the auto-generated PWA service worker with push notification functionality
...
self.addEventListener('message', function(event) {
  ...
  if (event.data?.type === 'ADD_PUSH_LISTENERS') {
    console.log('Push listeners already added');
    // They're already added above, just acknowledge
  }
});
